package owntasks.com.googlemap;
...
import com.example.rodrigo.nearbyplaces.GetNearbyPlacesData;
...
public class Map extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnBanks: {
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Map.this, "Showing Nearby Banks", Toast.LENGTH_SHORT).show();
                break;
            }
            case R.id.btnRestaurants: {
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Map.this, "Showing Nearby Restaurants", Toast.LENGTH_SHORT).show();
                break;
            }
            case R.id.btnSchools: {
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Map.this, "Showing Nearby Schools", Toast.LENGTH_SHORT).show();
                break;
            }
            case R.id.btnHotels: {
                mMap.clear();
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(Map.this, "Showing Nearby Hotels", Toast.LENGTH_SHORT).show();
                break;
            }
        }
    }
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlaceUrl.append("&key=" + "AIzaSyAPEwQWBQkSoAWHSDSzq5HLllzVimQJ4_U");
